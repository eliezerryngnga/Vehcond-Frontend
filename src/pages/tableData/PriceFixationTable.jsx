...
import { useFetchPriceFixedByTc } from '../../hooks/transportActions'; // Adjust path if needed

//import SearchInput from "../../components/core/SearchInput"

// Props: onOpenModal (function to call when an action button is clicked)
const PriceFixationTable = ({ onOpenModal }) => {
  ...
  const {
    ...
    isFetching,
    isPreviousData
  } = useFetchPriceFixedByTc(pageNumber, pageSize, debouncedSearchTerm);
  ...
  return (
    <Box p={{ base: 2, md: 4 }} borderWidth="1px" borderRadius="md" bg={containerBg} shadow="sm">
        <Heading size="md" mb={4} color={textColor}>Price as Fixed By TC</Heading>
                                    ...
                                    <DTr key={row.applicationCode}>
                                        ...
                                        <DTd>
                                            <HStack spacing={2}>
                                                ...
                                                <Button size="sm" colorScheme="teal" variant="outline" onClick={() => onOpenModal(row, 'Forward')}>
                                                    Fixation
                                                </Button>
                                            </HStack>
                                        </DTd>
...
export default PriceFixationTable;