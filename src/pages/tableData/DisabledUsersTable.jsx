...
import { useFetchAllDisabledUsers } from '../../hooks/adminActions'; // Adjust path if needed

//import SearchInput from "../../components/core/SearchInput"


// Props: onOpenModal (function to call when an action button is clicked)
const DisabledUsers = ({ onOpenModal }) => {
  ...
  const {
    ...
    isFetching,
    isPreviousData
  } = useFetchAllDisabledUsers(pageNumber, pageSize, debouncedSearchTerm);
  ...
  return (
    <Box p={{ base: 2, md: 4 }} borderWidth="1px" borderRadius="md" bg={containerBg} shadow="sm">
        <Heading size="md" mb={4} color={textColor}>Disabled Users</Heading>
                            ...
                            {!isFetching && fetchedData.length > 0 ? (
                                fetchedData.map((row) => (
                                    <DTr key={row.usercode}>
                                        ...
                                        {/* Status */}
                                        <DTd>
                                             <Tag size="sm" colorScheme={'red'} variant="subtle">Disabled</Tag>
                                        </DTd>
                                        ...
                                        <DTd>
                                            <HStack spacing={2}>
                                                ...
                                                <Button size="xs" colorScheme="teal" variant="outline" onClick={() => onOpenModal(row, 'enable')}>
                                                    Enable
                                                </Button>
                                            </HStack>
                                        </DTd>
