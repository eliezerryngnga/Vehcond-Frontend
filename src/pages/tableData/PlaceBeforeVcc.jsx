...
import { useFetchPlaceBeforeVcc } from '../../hooks/transportActions'; // Adjust path if needed

//import SearchInput from "../../components/core/SearchInput"

// Props: onOpenModal (function to call when an action button is clicked)
const PlaceBeforeVcc = ({ onOpenModal }) => {
  ...
  const {
    ...
    isFetching,
    isPreviousData
  } = useFetchPlaceBeforeVcc(pageNumber, pageSize, debouncedSearchTerm);
  ...
  return (
    <Box p={{ base: 2, md: 4 }} borderWidth="1px" borderRadius="md" bg={containerBg} shadow="sm">
        <Heading size="md" mb={4} color={textColor}>Place Before VCC </Heading>
                                    ...
                                    <DTr key={row.applicationCode}>
                                        ...
                                        <DTd>
                                            <HStack spacing={2}>
                                                ...
                                                <Button size="xs" colorScheme="teal" variant="outline" onClick={() => onOpenModal(row, 'forward')}>
                                                    Forward
                                                </Button>
