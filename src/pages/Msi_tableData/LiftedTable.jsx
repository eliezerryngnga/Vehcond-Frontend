...
const LiftedTable = ({filterValues, setSearch, setYear, setMonth}) => {
  ...
  const {
    ...
    isFetching,
    isPreviousData
  } = useFetchLiftedVehicle(pageNumber, pageSize, debouncedSearch);
 ...
 const startIndex = currentPageNumber * currentPageSize;
  ...
  return (
    <Box p={{ base: 2, md: 4 }} borderWidth="1px" borderRadius="md" bg={containerBg} shadow="sm">
        <Heading size="md" mb={4} color={textColor}>Lifted</Heading>
                    ...
                    <DataTable>
                        <DThead>
                            <DTr>
                                ...
                                <DTh>Lifter's Name</DTh>
                                <DTh>Lifter's Address</DTh>
                                <DTh>Lifted Date</DTh>
                            </DTr>
                        </DThead>
                        <DTbody>
