...
const NonLiftedVehicleTable = ({filterValues, setSearch, setYear, setMonth}) => {
  ...
  const {
    ...
    isFetching,
    isPreviousData
  } = useFetchNonLiftedVehicle(pageNumber, pageSize, debouncedSearch);
...
export default NonLiftedVehicleTable;